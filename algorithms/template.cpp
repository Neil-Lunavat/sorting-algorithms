...
/**
 * Register your algorithm (this runs automatically when the program starts)
 * Change the name and state size as needed
 */
static bool registered = []() {
    registerAlgorithm("Your Algorithm Name", yourAlgorithmName, 3); // 3 = number of state variables
    return true;
}();
